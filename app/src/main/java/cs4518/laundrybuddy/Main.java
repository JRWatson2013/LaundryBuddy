...
public class Main extends FragmentActivity implements OnMapReadyCallback {
    ...
    private Button mLaundromatTestButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLaundromatTestButton = (Button)findViewById(R.id.laundromat_test_button);
        mLaundromatTestButton.setOnClickListener(new View.OnClickListener(){
            @Override
